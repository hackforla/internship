...
- [ ] Customize issues that will need to be made by striking through unneeded issues from this list (put ~ before and after text to make it strikethrough).
  - [ ] Research structure set-up
  - [ ] Research roadmap
  - [ ] Research plan (internal)
  - [ ] Research plan ((external if needed) - this is a subset of the internal)
  - [ ] Reviewing the Google Drive for PII removal (a research audit for existing research plans)
  - [ ] Timeline
  - [ ] Forms/Survey/Script
  - [ ] Recruitment plan for participants (if non captive user groups)
  - [ ] Selection criteria for participants (if non captive user groups)
  - [ ] Identification of recruitment channels for participants (if non captive user groups)
  - [ ] Participants recruitment message draft for each type of channel (i.e. Slack, social) (if non captive user groups)
  - [ ] Consent plan for participants
  - [ ] Consent form/documents
  - [ ] Email/Communication to parents if participants are minor (if required)
  - [ ] Recruitment plan for extra UXRs (if required)
  - [ ] Selection criteria for UXRs (if required)
  - [ ] Identification of recruitment channels for UXRs (required)
  - [ ] UXRs recruitment message draft for each type of channel (i.e. Slack, social) (required)
  ...
  - [ ] Data synthesis
  - [ ] Reporting
  - [ ] Reviewing the Google Drive for PII removal
